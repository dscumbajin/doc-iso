  ...
  <div align='center'>
            ...
            <table cellspacing='0'>
              <tr>
                <td>
                  <table class='soapbox'>
                    <tr>
                      <td class='soapbox-title'>Mensaje enviado desde el formulario de compartir del sitio web <a style='font-weight: bold;' target='_blank' href='http://abisoftgt.net'>Abisoft GT</a></td>
                    </tr>
                  </table>
                  <table class='body'>
                    <tr>
                      ...
                      <td class='body-padded'>
                        <div class='body-title'>Mensaje enviado por: $nombre, ($email)</div>
                        <table class='body-text'>
                          <tr>
                            <td class='body-text-cell'>
                              <span style='font-weight: bold;' >Si ya tienes cuenta ingresa: </span><a style='color: blue' target='_blank' href='$url'>$url</a>
                              <br><br>
                              <span style='font-weight: bold;' >Aun no tienes cuenta?</span>
                              <a style='color: blue' target='_blank' href='$url2'>Ingresa aqui!</a><span style='font-weight: bold;' > para ver el archivo o copia y pega el enlace:  </span><a style='color: blue' href='$url2' target='_blank'>$url2</a>
                              <br><br>
                             <span style='font-weight: bold;' > o puedes decargarlo directamente entrando al enlace:</span>
                            <a style='color: blue' target='_blank' href='$url3'>$url3</a>
                        ...
                        <table class='body-signature-block'>
                          <tr>
                            <td class='body-signature-cell'>
                              <p>BY: <a target='_blank' href='http://abisoftgt.net'>www.abisoftgt.net</a>!</p>
    ...
    <table class='footer-wrap w320 full-width-gmail-android' bgcolor='#e5e5e5'>
      <tr>
        ...
        <td class='container'>
          <div class='content'>
            <a target='_blank' href='http://abisoftgt.net/blog/contact'>Contacto</a>&nbsp;&nbsp;|&nbsp;&nbsp;
            <span class='footer-group'>
              <a target='_blank' href='https://fb.com/abisoftgt.net'>Facebook</a>&nbsp;&nbsp;|&nbsp;&nbsp;
              <a target='_blank' href='http://abisoftgt.net'>Sitio Web</a>&nbsp;&nbsp;|&nbsp;&nbsp;
            </span>
          </div>
        </td>
        <td></td>
